...
def state_to_features(game_state: dict) -> np.array:
    ...
    *This is not a required function, but an idea to structure your code.*
    ...
    if len(coins)>0:
        coinf = look_for_targets_dist(free_space, location, coins, logger=None)
    ...
    #print(look_for_targets_dist(free_space, location, coins, logger=None))
